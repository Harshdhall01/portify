      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="font-body text-sm text-ocean-300">
            Build your portfolio in under 5 minutes
          </p>
        </div>
        ...
        <div className="glass rounded-2xl p-8 border border-ocean-700/40">
          ...
          <p className="text-center font-mono text-xs text-ocean-500 mt-4">
            By signing up you agree to our{' '}
            <a href="#" className="text-biolum-DEFAULT hover:underline">Terms</a>
            {' '}&{' '}
            <a href="#" className="text-biolum-DEFAULT hover:underline">Privacy Policy</a>
          </p>
        </div>

        <p className="text-center font-body text-sm text-ocean-400 mt-6">
          Already have an account?{' '}
          <Link to="/login" className="text-biolum-DEFAULT hover:underline font-medium">
            Sign in
          </Link>
        </p>
